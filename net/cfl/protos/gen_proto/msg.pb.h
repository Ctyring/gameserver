...
constexpr MessageID MessageID_MAX = static_cast<MessageID>(399999);
constexpr int MessageID_ARRAYSIZE = 399999 + 1;
...
const std::string& MessageID_Name(T value) {
  ...
  return ::google::protobuf::internal::NameOfEnum(MessageID_descriptor(), value);
}
...
template <>
struct is_proto_enum<::MessageID> : std::true_type {};
template <>
